...
# Generate all concept pairs
veggies_concepts <- unique(animals$concept)
veggies_concept_pairs <- combn(animal_concepts, 2, simplify = FALSE) 
...
write.csv(semantic_distances_animals_df, "animals.csv", row.names = FALSE)
#semantic_distances_animals_df

write.csv(semantic_distances_fruits_df, "fruits.csv", row.names = FALSE)
#semantic_distances_fruits_df

write.csv(semantic_distances_veggies_df, "veggies.csv", row.names = FALSE)
#semantic_distances_veggies_df

write.csv(semantic_distances_weather_df, "weather.csv", row.names = FALSE)
#semantic_distances_weather_df

write.csv(semantic_distances_clothes_df, "clothes.csv", row.names = FALSE)
#semantic_distances_clothes_df

write.csv(semantic_distances_scenes_df, "scenes.csv", row.names = FALSE)
#semantic_distances_scenes_df

write.csv(semantic_distances_emotions_df, "emotions.csv", row.names = FALSE)
#semantic_distances_emotions_df

write.csv(semantic_distances_values_df, "values.csv", row.names = FALSE)
#semantic_distances_values_df

write.csv(semantic_distances_carquals_df, "carquals.csv", row.names = FALSE)
#semantic_distances_carquals_df

write.csv(semantic_distances_location_df, "location.csv", row.names = FALSE)
#semantic_distances_location_df

write.csv(semantic_distances_time_df, "time.csv", row.names = FALSE)
#semantic_distances_time_df

write.csv(semantic_distances_transport_df, "transport.csv", row.names = FALSE)
#semantic_distances_transport_df

write.csv(semantic_distances_activity_df, "activity.csv", row.names = FALSE)
#semantic_distances_activity_df

#combine semantic distances data frames

#save combined semantic distanc data frame
```
